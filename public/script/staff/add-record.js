        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            showImmunizationCheckbox.addEventListener("change", function() {
                if (this.checked) {
                    ...
                    remarksSection.classList.remove("hidden-section"); // show remarks kapag naka-check
                    // Add an initial vaccine entry if none exist
                    if (immunizationEntries.children.length === 0) {
                        addVaccineEntry();
                    }
                } else {
                    immunizationSection.classList.add("hidden-section");
                    remarksSection.classList.add("hidden-section"); // hide remarks kapag unchecked
