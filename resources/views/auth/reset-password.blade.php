...
<head>
    ...
    <title>Reset Password - Letty's Birthing Home</title>
...
<body>
    <div class="reset-password-wrapper">
        <div class="welcome-section">
            ...
            <p>Create a new password to securely access your Letty's Birthing Home account.</p>
            <p>Ensure your password is strong and unique for better security.</p>
        </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group">
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                        name="email_display" value="{{ request()->query('email') }}" placeholder="Enter your email"
                        readonly aria-label="Email">
                    @error('email')
                ...
                <div class="form-group">
                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"
                        name="password" placeholder="Enter new password" required aria-label="New Password">
