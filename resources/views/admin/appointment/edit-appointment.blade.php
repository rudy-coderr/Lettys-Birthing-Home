...
<head>
    ...
    <title>Edit Appointment - Letty's Birthing Home</title>
    ...
    <main class="content">
        ...
        <div class="container-fluid main-content">
            <div class="form-card" id="appointmentSection">
                ...
                <form id="editAppointmentForm" method="POST" <form method="POST"
                    action="{{ route('admin.updateAppointment', $appointment->id) }}">
                    @csrf
                    @method('PUT')
