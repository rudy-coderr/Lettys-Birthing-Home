...
<head>
    ...
    <title>Birthing Home Care Tracker - Intrapartum Check-up</title>
        ...
        <header class="main-header navbar navbar-expand-lg navbar-light sticky-top mb-4">
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="page-title mb-0">Intrapartum Check-up</h4>
                </div>
                ...
                <div class="stage active" id="intrapartumStage">
                    <div class="form-card">
                        ...
                        <div class="form-section form-actions">
                            ...
                            <!-- Cancel button redirects to patient list, because delivery doesn't exist yet -->
                            <button type="button" class="btnn btnn-cancel" id="cancelDelivery">
