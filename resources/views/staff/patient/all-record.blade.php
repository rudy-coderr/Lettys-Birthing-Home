                        ...
                        @forelse($patients as $patient)
                            <tr data-id="{{ $patient->patient?->patient_id }}">
                                ...
                                <td class="actions-cell">
                                    <a href="{{ route('patient.pdfRecords', $patient->id) }}" class="action-btn view-btn"
                                        title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>

                                    <!-- Fixed edit button -->
                                    <a href="{{ route('patient.edit', $patient->id) }}" class="action-btn edit-btn"
                                        title="Update Patient Information">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <a href="{{ route('staff.addAppointment', ['client_id' => $patient->id]) }}"
                                        class="action-btn add-btn" title="Add Appointment">
